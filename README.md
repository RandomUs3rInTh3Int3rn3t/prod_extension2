# Mangayomi Extensions (Production) ✅

Custom extension repository for the Mangayomi app. Verified and production-ready non-NSFW extensions.



```
https://raw.githubusercontent.com/RandomUs3rInTh3Int3rn3t/prod_extension2/main/anime_index.json
```
