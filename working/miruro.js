...
class DefaultExtension extends MProvider {
    ...
    utf8ToBase64(str) {
        ...
        for (var j = 0; j < utf8Bytes.length; j += 3) {
            var b1 = utf8Bytes[j];
            var b2 = j + 1 < utf8Bytes.length ? utf8Bytes[j + 1] : 0;
            var b3 = j + 2 < utf8Bytes.length ? utf8Bytes[j + 2] : 0;
            ...
            if (j + 1 >= utf8Bytes.length) e3 = e4 = 64;
            else if (j + 2 >= utf8Bytes.length) e4 = 64;
    ...
    base64url(obj) {
        ...
        var b64 = "";
        if (typeof bytesToBase64 === "function" && typeof TextEncoder !== "undefined") {
            try {
                b64 = bytesToBase64(new TextEncoder().encode(str));
            } catch (e) {
                b64 = this.utf8ToBase64(str);
            }
        } else {
            b64 = this.utf8ToBase64(str);
        }
